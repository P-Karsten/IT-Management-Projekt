...
import { l as listen, d as IS_CHROME, e as IS_IOS, f as canGoogleCastSrc, I as IS_SERVER, g as loadScript } from './vidstack-D2YCgfrz.js';
import { p as peek } from './vidstack-DwBltyvo.js';
...
class GoogleCastLoader {
  ...
  async load(ctx) {
    ...
    return new (await import('./vidstack-B7VcIUL7.js')).GoogleCastProvider(this._player, ctx);
  }
