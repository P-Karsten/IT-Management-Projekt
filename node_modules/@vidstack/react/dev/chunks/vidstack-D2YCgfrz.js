...
class AudioProviderLoader {
  ...
  async load(ctx) {
    ...
    return new (await import('./vidstack-D4LbG1Mo.js')).AudioProvider(this.target, ctx);
  }
}
...
const _HLSProviderLoader = class _HLSProviderLoader extends VideoProviderLoader {
  ...
  async load(context) {
    ...
    return new (await import('./vidstack-7TaDvrF9.js')).HLSProvider(this.target, context);
  }
};
...
class VimeoProviderLoader {
  ...
  async load(ctx) {
    ...
    return new (await import('./vidstack-DWxrTRh3.js')).VimeoProvider(this.target, ctx);
  }
...
class YouTubeProviderLoader {
  ...
  async load(ctx) {
    ...
    return new (await import('./vidstack-BFs2p8An.js')).YouTubeProvider(this.target, ctx);
  }
  async loadPoster(src, ctx, abort) {
  ...
  async _requestGoogleCast(trigger) {
    try {
      ...
      if (!this._googleCastLoader) {
        const $module = await import('./vidstack-BSdi2tGy.js').then(function (n) { return n.d; });
