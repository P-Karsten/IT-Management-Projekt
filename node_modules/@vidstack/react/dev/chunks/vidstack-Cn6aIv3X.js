...
import { l as listen, d as IS_CHROME, e as IS_IOS, f as canGoogleCastSrc, I as IS_SERVER, g as loadScript } from './vidstack-CFehGpwZ.js';
...
class GoogleCastLoader {
  ...
  async load(ctx) {
    ...
    return new (await import('./vidstack-BuQLJsc_.js')).GoogleCastProvider(this._player, ctx);
  }
