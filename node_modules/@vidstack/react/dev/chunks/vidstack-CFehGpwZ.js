...
class AudioProviderLoader {
  ...
  async load(ctx) {
    ...
    return new (await import('./vidstack-DITuXdCT.js')).AudioProvider(this.target, ctx);
  }
}
...
const _HLSProviderLoader = class _HLSProviderLoader extends VideoProviderLoader {
  ...
  async load(context) {
    ...
    return new (await import('./vidstack-CP2Tq0M8.js')).HLSProvider(this.target, context);
  }
};
...
class VimeoProviderLoader {
  ...
  async load(ctx) {
    ...
    return new (await import('./vidstack-Dxpizkbs.js')).VimeoProvider(this.target, ctx);
  }
...
class YouTubeProviderLoader {
  ...
  async load(ctx) {
    ...
    return new (await import('./vidstack-B0t-1X7y.js')).YouTubeProvider(this.target, ctx);
  }
  async loadPoster(src, ctx, abort) {
  ...
  async _requestGoogleCast(trigger) {
    try {
      ...
      if (!this._googleCastLoader) {
        const $module = await import('./vidstack-Cn6aIv3X.js').then(function (n) { return n.d; });
