...
import { u as useSignal, k as isBoolean, y as uppercaseFirstChar, n as isUndefined, g as isArray, B as isKeyboardClick, l as listenEvent, P as toggleClass, m as camelToKebabCase, Q as useContext } from './vidstack-DwBltyvo.js';
import { k as createComputed, c as createSignal, M as MediaAnnouncer, R as Root, l as Trigger, m as Content, G as GoogleCastButton, d as Captions, j as useChapterOptions, n as Root$5, o as Root$6, p as Root$7, r as Root$a, v as Group, i as useChapterTitle, w as createEffect, h as useActiveTextTrack, C as ChapterTitle$1, T as Title, x as Root$b, y as Track$1, z as TrackFill$1 } from './vidstack-DOUBzzzy.js';
import { b as useColorSchemePreference, c as useActive, d as useResizeObserver, u as useLayoutName, e as useTransitionActive } from './vidstack-C_osbtAE.js';
...
import { u as useMediaState, a6 as isTrackCaptionKind, o as getDownloadFile, m as isRemotionSrc, s as sortVideoQualities, P as Primitive, Y as mediaContext } from './vidstack-D2YCgfrz.js';
import { flushSync } from 'react-dom';
import { R as RemotionThumbnail, b as RemotionSliderThumbnail } from './vidstack-DGnz3pCc.js';
...
function DefaultFontSetting({
  ...
  const player = useMediaPlayer(), id = `${group}-${label.toLowerCase()}`, translatedLabel = useDefaultLayoutWord(label), resets = React.useContext(FontResetContext);
  ...
  if (option.type === "color") {
    ...
    return /* @__PURE__ */ React.createElement(DefaultMenuItem, { label: translatedLabel }, /* @__PURE__ */ React.createElement("input", { className: "vds-color-picker", type: "color", value, onChange: onColorChange2 }));
  }
  if (option.type === "slider") {
    let onSliderValueChange2 = function(value2) {
      onChange(value2 + "%");
    };
...
function DefaultResetMenuItem() {
  ...
  return /* @__PURE__ */ React.createElement("button", { className: "vds-menu-item", role: "menuitem", onClick }, /* @__PURE__ */ React.createElement("span", { className: "vds-menu-item-label" }, resetText));
}
...
function DefaultPlaybackMenu({ slots }) {
  ...
  return /* @__PURE__ */ React.createElement(Root$3, { className: "vds-accessibility-menu vds-menu" }, /* @__PURE__ */ React.createElement(DefaultMenuButton, { label, Icon: Icons.Menu.Playback }), /* @__PURE__ */ React.createElement(Items, { className: "vds-menu-items" }, slot(slots, "playbackMenuItemsStart", null), /* @__PURE__ */ React.createElement(DefaultMenuSection, null, slot(slots, "playbackMenuLoop", /* @__PURE__ */ React.createElement(DefaultLoopMenuCheckbox, null))), /* @__PURE__ */ React.createElement(DefaultSpeedMenuSection, null), /* @__PURE__ */ React.createElement(DefaultQualityMenuSection, null), slot(slots, "playbackMenuItemsEnd", null)));
}
...
function AudioLayout() {
  ...
  useLayoutName("audio");
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(DefaultAnnouncer, null), /* @__PURE__ */ React.createElement(DefaultCaptions, null), /* @__PURE__ */ React.createElement(Root$a, { className: "vds-controls" }, /* @__PURE__ */ React.createElement(Group, { className: "vds-controls-group" }, slot(slots, "seekBackwardButton", /* @__PURE__ */ React.createElement(DefaultSeekButton, { backward: true, tooltip: "top start" })), slot(slots, "playButton", /* @__PURE__ */ React.createElement(DefaultPlayButton, { tooltip: "top center" })), slot(slots, "seekForwardButton", /* @__PURE__ */ React.createElement(DefaultSeekButton, { tooltip: "top center" })), /* @__PURE__ */ React.createElement(DefaultAudioTitle, null), slot(slots, "timeSlider", /* @__PURE__ */ React.createElement(DefaultTimeSlider, null)), /* @__PURE__ */ React.createElement(DefaultTimeInvert, null), /* @__PURE__ */ React.createElement(DefaultVolumePopup, { orientation: "vertical", tooltip: "top", slots }), slot(slots, "captionButton", /* @__PURE__ */ React.createElement(DefaultCaptionButton, { tooltip: "top center" })), slot(slots, "downloadButton", /* @__PURE__ */ React.createElement(DefaultDownloadButton, null)), /* @__PURE__ */ React.createElement(DefaultAudioMenus, { slots }))));
}
...
const DefaultKeyboardDisplay = React.forwardRef(
  ({ icons: Icons, ...props }, forwardRef) => {
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { className: "vds-kb-bezel", key: count }, Icon ? /* @__PURE__ */ React.createElement("div", { className: "vds-kb-icon" }, /* @__PURE__ */ React.createElement(Icon, null)) : null)
    );
  }
);
