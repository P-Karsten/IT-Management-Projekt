...
import { l as listen, d as IS_CHROME, e as IS_IOS, f as canGoogleCastSrc, I as IS_SERVER, g as loadScript } from './vidstack-3FvLzP0A.js';
import { p as peek } from './vidstack-wClXxc1a.js';
...
class GoogleCastLoader {
  ...
  async prompt(ctx) {
    ...
    try {
      ...
      if (isCastConnected())
        this.De(ctx, "connected", openEvent);
    } catch (code) {
  ...
  async load(ctx) {
    ...
    return new (await import('./vidstack-CCHC2BO9.js')).GoogleCastProvider(this.f, ctx);
  }
  async Fj(ctx) {
