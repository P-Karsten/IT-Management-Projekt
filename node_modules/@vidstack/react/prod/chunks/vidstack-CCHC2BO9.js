...
import { l as listenEvent, e as effect, q as untrack, d as createScope, r as keysOf, v as onDispose, D as DOMEvent, p as peek } from './vidstack-wClXxc1a.js';
import { L as ListSymbol, T as TimeRange, R as RAFLoop } from './vidstack-3FvLzP0A.js';
import { g as getCastSessionMedia, a as getCastContext, b as getCastSession, h as hasActiveCastSession, l as listenCastContextEvent, c as getCastErrorMessage } from './vidstack-BalIc3S7.js';
import 'react';
...
class GoogleCastProvider {
  ...
  Cj() {
    ...
    if (currentTime === this.va)
      return;
    const prevPlayed = this.ha, played = this.vc(currentTime), detail = { currentTime, played };
  ...
  ee(event) {
    if (!this.f.isMediaLoaded || this.Qa)
      return;
