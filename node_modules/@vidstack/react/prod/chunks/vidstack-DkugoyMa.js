...
import { l as listen, d as IS_CHROME, e as IS_IOS, f as canGoogleCastSrc, I as IS_SERVER, g as loadScript } from './vidstack-rCc44cc2.js';
...
class GoogleCastLoader {
  ...
  async load(ctx) {
    ...
    return new (await import('./vidstack-BWfs225e.js')).GoogleCastProvider(this.f, ctx);
  }
  async Fj(ctx) {
